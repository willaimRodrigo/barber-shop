...
export const Page = () => {
    ...
    const handleRemoveCorte = async (id) => {
        const response = await fetch('http://localhost:3005/cabelos/${id}', {
            method: 'DELETE',
            headers: new Headers({
                "Content-type": "application/json"
            }),
        ...
        if (response.ok) {
            alert("Corte removido com sucesso");
            getCortes();
        } else {
            alert(`Erro ao remover o corte: ${response.statusText}`)
        }
    }
    ...
    return (
        <>
            ...
            <section className={styles.section}>
                ...
                <ListCortes listCortes={cabelos} addItem={addItem} removeItem={handleRemoveCorte} categoria="cabelo" />
            </section>
            ...
            <section className={styles.section}>
                ...
                <form onSubmit={handleCorte} className={styles.inputcorte}>
                    <div className={styles.boxform}>


                        <FormInput className={styles.sectionform}
                            inputName="Imagem"
                            id="img"
                            type="text"
